/******************************************************************************
5. Tomá la solución del ejercicio anterior y analizá si elegiste el cliclo adecuado, y si
...
bool primo(int numero){    //(pares menos el 2  -> no son primos | no existe numero%mitadnumero que sea divisible por el numero 
    bool esprimo=false;
    int i;
